        ...
        <div className="modal-box max-w-min no-scrollbar">
            ...
            <div className="flex flex-col w-full lg:flex-row">
                ...
                <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                    ...
                    <button className="btn btn-primary" onClick={() => console.log(getPaths(nodes, edges))}></button>
                    <div className="h-96 aspect-square bg-red-200" />
                    <div className="h-96 aspect-square bg-green-200" />
                    <div className="h-96 aspect-square bg-yellow-200" />
                    <div className="h-96 aspect-square bg-base-content" />
                    <p>Testing</p> */}
