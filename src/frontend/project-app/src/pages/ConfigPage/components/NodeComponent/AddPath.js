...
const AddPath = () => {
    ...
    return (
        <>
            <input type="checkbox" id="addPath" className="modal-toggle" />

            <div className="modal">
            <div className="modal-box max-w-min no-scrollbar">
                {/* Close button */}
                <label id="close-addPath" htmlFor="addPath"/>
                <label htmlFor="addPath" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onClick={resetInputs}>✕</label>
